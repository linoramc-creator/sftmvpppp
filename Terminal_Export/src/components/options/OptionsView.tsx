      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-16">
        <div className="border border-amber-500/30 bg-amber-500/5 px-5 py-4">
          <div className="flex items-center gap-2 text-amber-400 text-[11px] tracking-widest uppercase mb-2">
            <AlertCircle className="h-4 w-4" /> Servicio de opciones no configurado
          </div>
          <p className="text-[12px] text-muted-foreground leading-relaxed">
            Define <code className="bg-primary/10 text-primary px-1">VITE_OPTIONS_API_URL</code> apuntando al
            microservicio Python (<code className="bg-primary/10 text-primary px-1">options-service/</code>).
            En local: <code className="bg-primary/10 text-primary px-1">uvicorn main:app --port 8001</code> y
            <code className="bg-primary/10 text-primary px-1 ml-1">VITE_OPTIONS_API_URL=http://localhost:8001</code>.
          </p>
        </div>
      </div>
    );
